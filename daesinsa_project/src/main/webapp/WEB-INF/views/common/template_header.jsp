 ...
 <!-- 로고 + 구매 / 대여 버튼 헤더 -->
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <button class="btn btn-outline-dark btn-sm me-md-2" type="button">구매</button>
        <button class="btn btn-outline-dark btn-sm me-md-2" type="button"
        onclick="location.href='${pageContext.request.contextPath}/member/insert'">대여</button>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu ">
              ...
              <li><a class="dropdown-item disabled second_menu" href="#">ACC</a>
                <ul class="dropdown-item third_menu"> 
                  <li><a href="${pageContext.request.contextPath}/shop/shoplist?c_id=C131&c_first=1">신발</a></li>
                  <li><a href="${pageContext.request.contextPath}/shop/shoplist?c_id=C132&c_first=1">가방</a></li>
