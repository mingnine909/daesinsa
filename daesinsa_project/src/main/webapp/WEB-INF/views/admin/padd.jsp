...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/admin/padd.css">
...
<%@ include file="/WEB-INF/views/admin/admin_sidebar.jsp"%>
  <div class="padd-wrapper">
        <div class="padd-container">
            <h4 style="text-align: left;">상품 등록</h4>
            <div class="padd-spacing-l"></div>
            <label for="exampleFormControlInput1" class="form-label">카테고리</label>
                <div class="padd-dropdown">
                    <div class="dropdown">
