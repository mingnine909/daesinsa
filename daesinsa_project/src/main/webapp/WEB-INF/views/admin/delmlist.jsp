...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/admin/delmlist.css">
...
<div class="delmlist-wrapper">
        <div class="delmlist-container">
            <h4 style="text-align: left;">탈퇴 회원 목록</h4>
            <div class="delmlist-spacing-l"></div>
            <div class="delmlist-dropdown">
                <div class="dropdown">
