  ...
  <div class="paging">
			<p>
				<c:if test="${startPage > 1 }">
					<a href="${pageContext.request.contextPath}/rent/search?keyword=${keyword }&page=${startPage-1 }"><span>이전</span></a>&nbsp;&nbsp;&nbsp;
			</c:if>
				<c:forEach begin="${startPage}" end="${endPage}" var="i">
					<a href="${pageContext.request.contextPath}/rent/search?keyword=${keyword }&page=${i}"><span>${i }</span></a>&nbsp;&nbsp;&nbsp;
			</c:forEach>
				<c:if test="${endPage < pageCnt}">
					<a href="${pageContext.request.contextPath}/rent/search?keyword=${keyword }&page=${endPage+1 }"><span>다음</span></a>&nbsp;&nbsp;&nbsp;
			</c:if>
			</p>
		</div>
